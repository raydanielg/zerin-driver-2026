  ...
  Widget build(BuildContext context) {
    return Column(spacing: Dimensions.paddingSizeSmall,children: [
      ...
      ButtonWidget(
        ...
        buttonText: '${'call_emergency'.tr} (${Get.find<SplashController>().config?.safetyFeatureEmergencyGovtNumber})',
        onPressed: (){
          launchUrl(Uri.parse("tel: ${Get.find<SplashController>().config?.safetyFeatureEmergencyGovtNumber}"));
        },
      ),
