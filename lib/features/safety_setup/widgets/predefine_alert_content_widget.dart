...
class PredefineAlertContentWidget extends StatefulWidget {
  final bool fromTripDetailsScree;
  const PredefineAlertContentWidget({super.key, this.fromTripDetailsScree = false});
            ...
            ButtonWidget(
              ...
              onPressed: (){
                safetyAlertController.storeSafetyAlert(controller.text).then((value){
                  if(value){
                    Get.back();
                    if(!widget.fromTripDetailsScree){
                      ...
                      messageText: GetBuilder<SafetyAlertController>(builder: (safetyAlertController){
                        return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          Row(spacing: Dimensions.paddingSizeSmall, children: [
                            ...
                            CircularProgressIndicator(color: Theme.of(Get.context!).primaryColor) :
                            InkWell(
