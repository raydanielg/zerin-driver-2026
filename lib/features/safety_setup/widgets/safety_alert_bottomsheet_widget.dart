            ...
            return Column(spacing: Dimensions.paddingSizeSmall,mainAxisSize: MainAxisSize.min, children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                BackButton(
                  ...
                  color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium?.color : null,
                ) :
                const SizedBox(),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(Images.crossIcon,height: 10,width: 10, color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium?.color : null),
                  ),
                ),
              ]),
              ...
              PredefineAlertContentWidget(fromTripDetailsScree: widget.fromTripDetailsScreen) :
