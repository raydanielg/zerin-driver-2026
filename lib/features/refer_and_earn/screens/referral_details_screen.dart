...
import 'package:zerin_driver/features/refer_and_earn/widgets/referral_earn_bottomsheet_widget.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: GetBuilder<ReferAndEarnController>(builder: (referAndEarnController){
        return (Get.find<SplashController>().config?.referralEarningStatus ?? false) ?
        SingleChildScrollView(
          child: Column(children: [
            SvgPicture.asset(Images.referAndEarnGraphics, height: 120, width: 120),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Text('invite_friend_getRewards'.tr,style: textSemiBold.copyWith(fontSize: 16)),
            const SizedBox(height: Dimensions.paddingSizeSmall),
            ...
            Padding(
              ...
              child: RichText(text: TextSpan(
                  ...
                  children: [TextSpan(
                    text: '  ${PriceConverter.convertPrice(context, referAndEarnController.referralDetails?.data?.shareCodeEarning ?? 0)}  ',
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Text('invite_or_share_the_code'.tr, textAlign: TextAlign.center,style: textRegular.copyWith(
                      ...
                      color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.6) : Theme.of(context).colorScheme.secondaryFixedDim,
                    ))
                  ]),
                ),
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Text('your_friend_sign_up'.tr,textAlign: TextAlign.center,style: textRegular.copyWith(
                      fontSize: Dimensions.fontSizeExtraSmall,color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.6) : Theme.of(context).colorScheme.secondaryFixedDim,
                    ))
                  ]),
                ),
