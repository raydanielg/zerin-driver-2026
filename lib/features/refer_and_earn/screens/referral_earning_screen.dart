...
import 'package:zerin_driver/features/refer_and_earn/widgets/custom_itle.dart';
import 'package:zerin_driver/features/refer_and_earn/widgets/earning_card_widget.dart';
            ...
            Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(PriceConverter.convertPrice(context, Get.find<ProfileController>().profileInfo?.wallet?.referralEarn ?? 0),style: textRobotoBold.copyWith(color: Theme.of(context).primaryColor,fontSize: 20))
                ]),
