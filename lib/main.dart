...
import 'package:zerin_driver/features/splash/screens/splash_screen.dart';
...
import 'package:zerin_driver/helper/di_container.dart' as di;
import 'package:zerin_driver/localization/localization_controller.dart';
import 'package:zerin_driver/localization/messages.dart';
import 'package:zerin_driver/theme/dark_theme.dart';
import 'package:zerin_driver/theme/light_theme.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle.dark.copyWith(
        statusBarColor: Get.isDarkMode? const Color(0xFF2E7D32) : const Color(0xFF4CAF50),
