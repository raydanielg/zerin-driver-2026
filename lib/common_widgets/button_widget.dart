...
class ButtonWidget extends StatelessWidget {
  ...
  const ButtonWidget({
    ...
    this.width = Dimensions.webMaxWidth, this.height = 50, this.fontSize, this.radius = 12, this.icon,this.showBorder = false,this.borderWidth=1,
  ...
  Widget build(BuildContext context) {
    final ButtonStyle flatButtonStyle = TextButton.styleFrom(
      elevation: 2,
      shadowColor: (backgroundColor ?? Theme.of(context).primaryColor).withValues(alpha: 0.3),
      backgroundColor:
