...
import 'package:zerin_driver/features/realtime_location_trac/screens/live_location_screen.dart';
import 'package:zerin_driver/localization/language_selection_screen.dart';
import 'package:zerin_driver/localization/localization_controller.dart';
import 'package:zerin_driver/features/auth/screens/sign_in_screen.dart';
...
import 'package:zerin_driver/features/location/screens/access_location_screen.dart';
...
import 'package:zerin_driver/features/splash/screens/app_version_warning_screen.dart';
import 'package:zerin_driver/helper/firebase_helper.dart';
import 'package:zerin_driver/helper/notification_helper.dart';
...
class LoginHelper{
  ...
  void handleIncomingLinks(Map<String, dynamic>? notificationData) async {
    ...
    try {
      ...
      print('Error in handleIncomingLinks: $e');
      // If config fails, still try to proceed with default routing
      if (Get.find<LocalizationController>().haveLocalLanguageCode()) {
        checkLoginRoutes(notificationData);
      } else {
        Get.offAll(() => LanguageSelectionScreen(notificationData: notificationData));
